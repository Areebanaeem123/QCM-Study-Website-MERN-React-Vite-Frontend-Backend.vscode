  ...
  return (
    <div className="space-y-6" suppressHydrationWarning>
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground md:text-3xl">Bienvenue, Alex !</h1>
        ...
        <Card>
          <CardContent className="flex items-center gap-4 pt-6">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-foreground">1,750</p>
            </div>
          </CardContent>
        </Card>
        <Card>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-foreground">Aperçu des Performances</CardTitle>
            <CardDescription>Vos scores par catégorie</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Vos derniers QCM et examens</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-foreground">Mes Packs Achetés</CardTitle>
          <CardDescription>Suivez votre progression dans chaque pack</CardDescription>
        </CardHeader>
        <CardContent>
            ...
            {purchasedPacks.map((pack) => (
              <div key={pack.id} className="rounded-lg border border-border p-4">
                ...
                <div className="mt-3 space-y-2">
                  ...
                  <p className="text-right text-sm text-muted-foreground">{pack.progress}% complété</p>
                </div>
                <Button className="mt-3 w-full" size="sm" asChild>
                  <Link href={`/tableau-de-bord/commencer-qcm?pack=${pack.id}`}>Continuer</Link>
                </Button>
              </div>
            ))}
          </div>
